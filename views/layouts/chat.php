        ...
        <div class="container" style="max-width: 1000px;">
            ...
            <div class="row">
                ...
                <?php } ?>
                    ...
                    <div class="panel panel-info "> 
                        <div class="panel-heading panel-right text-center"><small> <?php echo Yii::t('app', 'Ayuda en linea');?> </small> </div>
                        <div class="panel-body panel-body-right">
                            <a target="_blank" href="<?php echo Url::to(['/site/ayuda-en-linea']); ?>"><?php echo Yii::t('app', 'Click aqui para contactar a un agente');?></a>                            
                        </div> 
                    </div>

...
use app\models\BuscadorEmpresa;
...
<div class="inventario-form">	
    ...
    <?php if($model->foto!="" && file_exists (Yii::$app->basePath.'/web/imagenes/thumbnail/'.$model->foto)){?>        
            <img class="img-thumbnail" data-src="holder.js/100x100" alt="64x64" style="width:100px; height: 100px;" src="<?php echo Yii::getAlias('@web')."/imagenes/thumbnail/".$model->foto."";?>" data-holder-rendered="true"/>                             
    <?php }else{?>                
    ...
    <?php echo  $form->field($model, 'empresa_id')->dropdownList(BuscadorEmpresa::obtenerEmpresas(), ['prompt' => Yii::t('app', 'Seleccionar')]); ?>	
